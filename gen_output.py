...
fa_ns = {}
exec(open("C:/github/Telegram-shop-Physical/gen_translations.py", encoding="utf-8").read(), fa_ns)  # noqa: S102, SIM115 — one-off dev codegen script
fa = fa_ns["fa"]

ps_ns = {}
exec(open("C:/github/Telegram-shop-Physical/gen_all_translations.py", encoding="utf-8").read(), ps_ns)  # noqa: S102, SIM115 — one-off dev codegen script
ps = ps_ns["ps"]
fr = ps_ns["fr"]
