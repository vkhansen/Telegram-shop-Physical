...
> Scorecard: `docs/later/CARD-40-parity-scorecard.md`

- [ ] **Service boundary:** Business rules live in `bot/services/*` or `bot/platform/*` (not only in a Telegram handler / Astro page).
- [ ] **Capability key:** Uses an existing `CAPABILITY_KEYS` entry (or adds one + updates the [parity matrix](../docs/later/CARD-40-parity-matrix.md)).
