...
def main_menu(role: int, channel: str | None = None, helper: str | None = None) -> InlineKeyboardMarkup:
    ...
    kb.button(text=localize("btn.search"), callback_data="search_products")
...
def admin_console_keyboard() -> InlineKeyboardMarkup:
    ...
    kb.button(text=localize("admin.menu.coupons"), callback_data="coupon_management")
    kb.button(text=localize("admin.menu.accounting"), callback_data="admin_accounting")
    kb.button(text=localize("admin.menu.tickets"), callback_data="admin_tickets")
    kb.button(text=localize("admin.menu.stores"), callback_data="store_management")
