...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "admin.store.set_menu_image": "🖼 Установить изображение меню",
        "admin.store.set_promptpay": "💳 Настроить счёт PromptPay",
        "admin.store.set_static_qr": "📷 Установить статичный QR",
        "admin.store.prompt_menu_image": "Отправьте фото меню (или «-», чтобы очистить).",
        "admin.store.prompt_promptpay_id": "Отправьте PromptPay id филиала (телефон или нац. ID) или «-», чтобы очистить.",
        "admin.store.prompt_promptpay_name": "Отправьте имя счёта PromptPay филиала (или «-», чтобы пропустить).",
        "admin.store.prompt_static_qr": "Отправьте фото статичного QR (или «-», чтобы очистить).",
        "admin.store.asset_updated": "✅ Платёжные настройки точки обновлены.",
        "admin.store.expected_photo": "Пожалуйста, отправьте фото или «-», чтобы очистить.",
        "admin.store.invalid_promptpay": "Неверный PromptPay id — нужен 10-значный телефон или 13-значный нац. ID.",
    ...
    "en": {
        ...
        "admin.store.set_menu_image": "🖼 Set menu image",
        "admin.store.set_promptpay": "💳 Set PromptPay account",
        "admin.store.set_static_qr": "📷 Set static QR image",
        "admin.store.prompt_menu_image": "Send the menu board photo (or '-' to clear).",
        "admin.store.prompt_promptpay_id": "Send this branch's PromptPay id (phone or national id), or '-' to clear.",
        "admin.store.prompt_promptpay_name": "Send this branch's PromptPay account name (or '-' to skip).",
        "admin.store.prompt_static_qr": "Send the static QR photo (or '-' to clear).",
        "admin.store.asset_updated": "✅ Store payment settings updated.",
        "admin.store.expected_photo": "Please send a photo, or '-' to clear.",
        "admin.store.invalid_promptpay": "Invalid PromptPay id — must be a 10-digit phone or 13-digit national id.",
