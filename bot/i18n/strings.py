...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "btn.saved_carts": "🛒 Сохранённые корзины ({n})",
        "btn.restore_cart": "♻️ Восстановить {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 Ваши сохранённые корзины",
        "saved_carts.empty": "У вас нет сохранённых корзин.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} поз. — ฿{total}",
        "saved_carts.restored": "✅ Восстановлено позиций: {restored}.",
        "saved_carts.restored_partial": "✅ Восстановлено позиций: {restored}.\n⚠️ Пропущено (недоступно):\n{skipped}",
        "saved_carts.discarded": "🗑 Сохранённая корзина удалена.",
        "saved_carts.not_found": "Эта сохранённая корзина больше недоступна.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ Введите сумму вручную при оплате.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 Регистрация курьера. Ответьте на несколько вопросов, чтобы подать заявку.",
        "driver.register.ask_name": "Как вас зовут (полное имя)?",
        "driver.register.invalid_name": "Пожалуйста, отправьте корректное имя (до 120 символов).",
        "driver.register.ask_phone": "Какой у вас номер телефона?",
        "driver.register.invalid_phone": "Пожалуйста, отправьте корректный номер телефона.",
        "driver.register.ask_vehicle": "Какой транспорт вы используете?",
        "driver.register.invalid_vehicle": "Пожалуйста, выберите транспорт с помощью кнопок.",
        "driver.register.submitted": "✅ Заявка отправлена! Администратор скоро её рассмотрит.",
        "driver.vehicle.motorbike": "🏍 Мотоцикл",
        "driver.vehicle.car": "🚗 Автомобиль",
        "driver.vehicle.bicycle": "🚲 Велосипед",
        "driver.vehicle.foot": "🚶 Пешком",
        "driver.approved": "🎉 Вы одобрены как курьер! Отправьте /driver, чтобы выйти на линию.",
        "driver.rejected": "Ваша заявка на курьера не одобрена.",
        "driver.not_approved": "Ваш аккаунт курьера ещё не одобрен.",
        "driver.status.pending": "⏳ Ваша заявка на курьера ожидает одобрения.",
        "driver.status.rejected": "❌ Ваша заявка на курьера отклонена.",
        "driver.status.suspended": "🚫 Ваш аккаунт курьера приостановлен.",
        "driver.status.online": "🟢 Вы НА ЛИНИИ. Активных заказов: {active}.",
        "driver.status.offline": "⚪ Вы НЕ НА ЛИНИИ. Активных заказов: {active}.",
        "driver.menu.go_online": "🟢 Выйти на линию",
        "driver.menu.go_offline": "⚪ Уйти с линии",
        "driver.online.prompt_location": "🟢 Вы на линии! Поделитесь своей геопозицией в реальном времени, чтобы мы подбирали вам ближайшие заказы.",
        "driver.offline.done": "Вы ушли с линии.",
        "driver.location.received": "📍 Геопозиция обновлена.",
        "driver.offer.title": "🛎 Новый заказ на доставку — заказ {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ Принять",
        "driver.offer.decline_btn": "❌ Отклонить",
        "driver.offer.accepted": "✅ Заказ {order_code} ваш!\n📍 {address}\nНажимайте кнопки ниже по мере получения и доставки.",
        "driver.offer.accept_ack": "✅ Вы взяли этот заказ!",
        "driver.offer.taken": "Извините, этот заказ уже взят.",
        "driver.offer.declined": "Вы отклонили это предложение.",
        "driver.offer.expired": "Предложение по заказу {order_code} истекло.",
        "driver.customer.assigned": "🛵 Курьер уже в пути по вашему заказу #{order_code}!",
        "driver.customer.eta": "🛵 Ваш заказ #{order_code} прибудет примерно через {minutes} мин.",
        "admin.driver.new_application": "🛵 Новая заявка курьера\nИмя: {name}\nТелефон: {phone}\nТранспорт: {vehicle}\nTelegram ID: {tg}",
        "admin.driver.approve_btn": "✅ Одобрить",
        "admin.driver.reject_btn": "❌ Отклонить",
        "admin.driver.approved_admin": "✅ Курьер одобрен.",
    ...
    "en": {
        ...
        "btn.saved_carts": "🛒 Saved Carts ({n})",
        "btn.restore_cart": "♻️ Restore {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 Your saved carts",
        "saved_carts.empty": "You have no saved carts.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} item(s) — ฿{total}",
        "saved_carts.restored": "✅ Restored {restored} item(s) to your cart.",
        "saved_carts.restored_partial": "✅ Restored {restored} item(s).\n⚠️ Skipped (no longer available):\n{skipped}",
        "saved_carts.discarded": "🗑 Saved cart removed.",
        "saved_carts.not_found": "This saved cart is no longer available.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ Enter the amount manually when paying.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 Driver registration. Answer a few questions to apply.",
        "driver.register.ask_name": "What is your full name?",
        "driver.register.invalid_name": "Please send a valid name (up to 120 characters).",
        "driver.register.ask_phone": "What is your phone number?",
        "driver.register.invalid_phone": "Please send a valid phone number.",
        "driver.register.ask_vehicle": "What vehicle do you use?",
        "driver.register.invalid_vehicle": "Please choose a vehicle from the buttons.",
        "driver.register.submitted": "✅ Application submitted! An admin will review it shortly.",
        "driver.vehicle.motorbike": "🏍 Motorbike",
        "driver.vehicle.car": "🚗 Car",
        "driver.vehicle.bicycle": "🚲 Bicycle",
        "driver.vehicle.foot": "🚶 On foot",
        "driver.approved": "🎉 You're approved as a driver! Send /driver to go online.",
        "driver.rejected": "Your driver application was not approved.",
        "driver.not_approved": "Your driver account is not approved yet.",
        "driver.status.pending": "⏳ Your driver application is pending approval.",
        "driver.status.rejected": "❌ Your driver application was rejected.",
        "driver.status.suspended": "🚫 Your driver account is suspended.",
        "driver.status.online": "🟢 You are ONLINE. Active orders: {active}.",
        "driver.status.offline": "⚪ You are OFFLINE. Active orders: {active}.",
        "driver.menu.go_online": "🟢 Go online",
        "driver.menu.go_offline": "⚪ Go offline",
        "driver.online.prompt_location": "🟢 You're online! Share your live location so we can match you to nearby orders.",
        "driver.offline.done": "You're now offline.",
        "driver.location.received": "📍 Location updated.",
        "driver.offer.title": "🛎 New delivery offer — order {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ Accept",
        "driver.offer.decline_btn": "❌ Decline",
        "driver.offer.accepted": "✅ Order {order_code} is yours!\n📍 {address}\nTap below as you pick up and deliver.",
        "driver.offer.accept_ack": "✅ You took this order!",
        "driver.offer.taken": "Sorry, this order has already been taken.",
        "driver.offer.declined": "You declined this offer.",
        "driver.offer.expired": "Offer for order {order_code} has expired.",
        "driver.customer.assigned": "🛵 A driver is on the way for your order #{order_code}!",
        "driver.customer.eta": "🛵 Your order #{order_code} is about {minutes} min away.",
        "admin.driver.new_application": "🛵 New driver application\nName: {name}\nPhone: {phone}\nVehicle: {vehicle}\nTelegram ID: {tg}",
        "admin.driver.approve_btn": "✅ Approve",
        "admin.driver.reject_btn": "❌ Reject",
        "admin.driver.approved_admin": "✅ Driver approved.",
    ...
    "th": {
        ...
        "btn.saved_carts": "🛒 ตะกร้าที่บันทึกไว้ ({n})",
        "btn.restore_cart": "♻️ กู้คืน {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 ตะกร้าที่คุณบันทึกไว้",
        "saved_carts.empty": "คุณยังไม่มีตะกร้าที่บันทึกไว้",
        "saved_carts.entry": "🛒 {brand}{store} · {n} รายการ — ฿{total}",
        "saved_carts.restored": "✅ กู้คืน {restored} รายการลงในตะกร้าแล้ว",
        "saved_carts.restored_partial": "✅ กู้คืน {restored} รายการแล้ว\n⚠️ ข้ามรายการที่ไม่พร้อมจำหน่าย:\n{skipped}",
        "saved_carts.discarded": "🗑 ลบตะกร้าที่บันทึกไว้แล้ว",
        "saved_carts.not_found": "ตะกร้าที่บันทึกไว้นี้ไม่พร้อมใช้งานอีกต่อไป",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ กรุณากรอกจำนวนเงินเองตอนชำระ",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 ลงทะเบียนคนขับ ตอบคำถามสองสามข้อเพื่อสมัคร",
        "driver.register.ask_name": "ชื่อ-นามสกุลของคุณคืออะไร?",
        "driver.register.invalid_name": "กรุณาส่งชื่อที่ถูกต้อง (ไม่เกิน 120 ตัวอักษร)",
        "driver.register.ask_phone": "เบอร์โทรศัพท์ของคุณคืออะไร?",
        "driver.register.invalid_phone": "กรุณาส่งเบอร์โทรศัพท์ที่ถูกต้อง",
        "driver.register.ask_vehicle": "คุณใช้ยานพาหนะอะไร?",
        "driver.register.invalid_vehicle": "กรุณาเลือกยานพาหนะจากปุ่ม",
        "driver.register.submitted": "✅ ส่งใบสมัครแล้ว! ผู้ดูแลจะตรวจสอบในไม่ช้า",
        "driver.vehicle.motorbike": "🏍 มอเตอร์ไซค์",
        "driver.vehicle.car": "🚗 รถยนต์",
        "driver.vehicle.bicycle": "🚲 จักรยาน",
        "driver.vehicle.foot": "🚶 เดินเท้า",
        "driver.approved": "🎉 คุณได้รับอนุมัติเป็นคนขับแล้ว! พิมพ์ /driver เพื่อออนไลน์",
        "driver.rejected": "ใบสมัครคนขับของคุณไม่ได้รับอนุมัติ",
        "driver.not_approved": "บัญชีคนขับของคุณยังไม่ได้รับอนุมัติ",
        "driver.status.pending": "⏳ ใบสมัครคนขับของคุณกำลังรอการอนุมัติ",
        "driver.status.rejected": "❌ ใบสมัครคนขับของคุณถูกปฏิเสธ",
        "driver.status.suspended": "🚫 บัญชีคนขับของคุณถูกระงับ",
        "driver.status.online": "🟢 คุณกำลังออนไลน์ ออเดอร์ที่กำลังทำ: {active}",
        "driver.status.offline": "⚪ คุณออฟไลน์อยู่ ออเดอร์ที่กำลังทำ: {active}",
        "driver.menu.go_online": "🟢 ออนไลน์",
        "driver.menu.go_offline": "⚪ ออฟไลน์",
        "driver.online.prompt_location": "🟢 คุณออนไลน์แล้ว! แชร์ตำแหน่งสดของคุณเพื่อให้เราจับคู่ออเดอร์ใกล้เคียงให้",
        "driver.offline.done": "คุณออฟไลน์แล้ว",
        "driver.location.received": "📍 อัปเดตตำแหน่งแล้ว",
        "driver.offer.title": "🛎 มีงานจัดส่งใหม่ — ออเดอร์ {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ รับงาน",
        "driver.offer.decline_btn": "❌ ปฏิเสธ",
        "driver.offer.accepted": "✅ ออเดอร์ {order_code} เป็นของคุณแล้ว!\n📍 {address}\nกดปุ่มด้านล่างเมื่อรับและจัดส่ง",
        "driver.offer.accept_ack": "✅ คุณรับออเดอร์นี้แล้ว!",
        "driver.offer.taken": "ขออภัย ออเดอร์นี้มีคนรับไปแล้ว",
        "driver.offer.declined": "คุณปฏิเสธงานนี้",
        "driver.offer.expired": "งานสำหรับออเดอร์ {order_code} หมดเวลาแล้ว",
        "driver.customer.assigned": "🛵 คนขับกำลังเดินทางมาส่งออเดอร์ #{order_code} ของคุณ!",
        "driver.customer.eta": "🛵 ออเดอร์ #{order_code} ของคุณจะถึงในอีกประมาณ {minutes} นาที",
        "admin.driver.new_application": "🛵 ใบสมัครคนขับใหม่\nชื่อ: {name}\nโทร: {phone}\nยานพาหนะ: {vehicle}\nTelegram ID: {tg}",
        "admin.driver.approve_btn": "✅ อนุมัติ",
        "admin.driver.reject_btn": "❌ ปฏิเสธ",
        "admin.driver.approved_admin": "✅ อนุมัติคนขับแล้ว",
    ...
    "ar": {
        ...
        "btn.saved_carts": "🛒 السلال المحفوظة ({n})",
        "btn.restore_cart": "♻️ استعادة {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 سلالك المحفوظة",
        "saved_carts.empty": "ليس لديك سلال محفوظة.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} عنصر — ฿{total}",
        "saved_carts.restored": "✅ تمت استعادة {restored} عنصرًا إلى سلتك.",
        "saved_carts.restored_partial": "✅ تمت استعادة {restored} عنصرًا.\n⚠️ تم تخطّي (غير متوفّر):\n{skipped}",
        "saved_carts.discarded": "🗑 تم حذف السلة المحفوظة.",
        "saved_carts.not_found": "هذه السلة المحفوظة لم تعد متاحة.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ أدخل المبلغ يدويًا عند الدفع.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 تسجيل السائق. أجب عن بعض الأسئلة للتقديم.",
        "driver.register.ask_name": "ما هو اسمك الكامل؟",
        "driver.register.invalid_name": "يرجى إرسال اسم صحيح (حتى 120 حرفًا).",
        "driver.register.ask_phone": "ما هو رقم هاتفك؟",
        "driver.register.invalid_phone": "يرجى إرسال رقم هاتف صحيح.",
        "driver.register.ask_vehicle": "ما هي وسيلة النقل التي تستخدمها؟",
        "driver.register.invalid_vehicle": "يرجى اختيار وسيلة نقل من الأزرار.",
        "driver.register.submitted": "✅ تم إرسال الطلب! سيراجعه المشرف قريبًا.",
        "driver.vehicle.motorbike": "🏍 دراجة نارية",
        "driver.vehicle.car": "🚗 سيارة",
        "driver.vehicle.bicycle": "🚲 دراجة هوائية",
        "driver.vehicle.foot": "🚶 سيرًا على الأقدام",
        "driver.approved": "🎉 تمت الموافقة عليك كسائق! أرسل /driver للاتصال.",
        "driver.rejected": "لم تتم الموافقة على طلب السائق الخاص بك.",
        "driver.not_approved": "حساب السائق الخاص بك لم تتم الموافقة عليه بعد.",
        "driver.status.pending": "⏳ طلب السائق الخاص بك قيد الموافقة.",
        "driver.status.rejected": "❌ تم رفض طلب السائق الخاص بك.",
        "driver.status.suspended": "🚫 حساب السائق الخاص بك موقوف.",
        "driver.status.online": "🟢 أنت متصل. الطلبات النشطة: {active}.",
        "driver.status.offline": "⚪ أنت غير متصل. الطلبات النشطة: {active}.",
        "driver.menu.go_online": "🟢 الاتصال",
        "driver.menu.go_offline": "⚪ قطع الاتصال",
        "driver.online.prompt_location": "🟢 أنت متصل الآن! شارك موقعك المباشر لنطابقك مع الطلبات القريبة.",
        "driver.offline.done": "أنت الآن غير متصل.",
        "driver.location.received": "📍 تم تحديث الموقع.",
        "driver.offer.title": "🛎 عرض توصيل جديد — الطلب {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ قبول",
        "driver.offer.decline_btn": "❌ رفض",
        "driver.offer.accepted": "✅ الطلب {order_code} لك الآن!\n📍 {address}\nاضغط الأزرار أدناه عند الاستلام والتسليم.",
        "driver.offer.accept_ack": "✅ لقد أخذت هذا الطلب!",
        "driver.offer.taken": "عذرًا، تم أخذ هذا الطلب بالفعل.",
        "driver.offer.declined": "لقد رفضت هذا العرض.",
        "driver.offer.expired": "انتهت صلاحية العرض للطلب {order_code}.",
        "driver.customer.assigned": "🛵 هناك سائق في الطريق لطلبك رقم #{order_code}!",
        "driver.customer.eta": "🛵 طلبك رقم #{order_code} يبعد حوالي {minutes} دقيقة.",
        "admin.driver.new_application": "🛵 طلب سائق جديد\nالاسم: {name}\nالهاتف: {phone}\nالمركبة: {vehicle}\nمعرف تيليجرام: {tg}",
        "admin.driver.approve_btn": "✅ موافقة",
        "admin.driver.reject_btn": "❌ رفض",
        "admin.driver.approved_admin": "✅ تمت الموافقة على السائق.",
    ...
    "fa": {
        ...
        "btn.saved_carts": "🛒 سبدهای ذخیره‌شده ({n})",
        "btn.restore_cart": "♻️ بازیابی {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 سبدهای ذخیره‌شده شما",
        "saved_carts.empty": "شما هیچ سبد ذخیره‌شده‌ای ندارید.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} مورد — ฿{total}",
        "saved_carts.restored": "✅ {restored} مورد به سبد شما بازیابی شد.",
        "saved_carts.restored_partial": "✅ {restored} مورد بازیابی شد.\n⚠️ نادیده گرفته شد (ناموجود):\n{skipped}",
        "saved_carts.discarded": "🗑 سبد ذخیره‌شده حذف شد.",
        "saved_carts.not_found": "این سبد ذخیره‌شده دیگر در دسترس نیست.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ هنگام پرداخت مبلغ را دستی وارد کنید.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 ثبت‌نام راننده. برای درخواست به چند سؤال پاسخ دهید.",
        "driver.register.ask_name": "نام کامل شما چیست؟",
        "driver.register.invalid_name": "لطفاً یک نام معتبر ارسال کنید (حداکثر ۱۲۰ کاراکتر).",
        "driver.register.ask_phone": "شماره تلفن شما چیست؟",
        "driver.register.invalid_phone": "لطفاً یک شماره تلفن معتبر ارسال کنید.",
        "driver.register.ask_vehicle": "از چه وسیله‌ای استفاده می‌کنید؟",
        "driver.register.invalid_vehicle": "لطفاً وسیله را از دکمه‌ها انتخاب کنید.",
        "driver.register.submitted": "✅ درخواست ارسال شد! مدیر به‌زودی آن را بررسی می‌کند.",
        "driver.vehicle.motorbike": "🏍 موتورسیکلت",
        "driver.vehicle.car": "🚗 خودرو",
        "driver.vehicle.bicycle": "🚲 دوچرخه",
        "driver.vehicle.foot": "🚶 پیاده",
        "driver.approved": "🎉 شما به‌عنوان راننده تأیید شدید! برای آنلاین شدن /driver را بفرستید.",
        "driver.rejected": "درخواست رانندگی شما تأیید نشد.",
        "driver.not_approved": "حساب راننده شما هنوز تأیید نشده است.",
        "driver.status.pending": "⏳ درخواست رانندگی شما در انتظار تأیید است.",
        "driver.status.rejected": "❌ درخواست رانندگی شما رد شد.",
        "driver.status.suspended": "🚫 حساب راننده شما معلق شده است.",
        "driver.status.online": "🟢 شما آنلاین هستید. سفارش‌های فعال: {active}.",
        "driver.status.offline": "⚪ شما آفلاین هستید. سفارش‌های فعال: {active}.",
        "driver.menu.go_online": "🟢 آنلاین شدن",
        "driver.menu.go_offline": "⚪ آفلاین شدن",
        "driver.online.prompt_location": "🟢 شما آنلاین شدید! موقعیت زنده خود را به اشتراک بگذارید تا سفارش‌های نزدیک را به شما اختصاص دهیم.",
        "driver.offline.done": "اکنون آفلاین هستید.",
        "driver.location.received": "📍 موقعیت به‌روزرسانی شد.",
        "driver.offer.title": "🛎 پیشنهاد تحویل جدید — سفارش {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ پذیرفتن",
        "driver.offer.decline_btn": "❌ رد کردن",
        "driver.offer.accepted": "✅ سفارش {order_code} مال شماست!\n📍 {address}\nهنگام تحویل گرفتن و رساندن، دکمه‌های زیر را بزنید.",
        "driver.offer.accept_ack": "✅ این سفارش را گرفتید!",
        "driver.offer.taken": "متأسفیم، این سفارش قبلاً گرفته شده است.",
        "driver.offer.declined": "این پیشنهاد را رد کردید.",
        "driver.offer.expired": "پیشنهاد سفارش {order_code} منقضی شد.",
        "driver.customer.assigned": "🛵 یک راننده برای سفارش #{order_code} شما در راه است!",
        "driver.customer.eta": "🛵 سفارش #{order_code} شما تقریباً {minutes} دقیقه دیگر می‌رسد.",
        "admin.driver.new_application": "🛵 درخواست راننده جدید\nنام: {name}\nتلفن: {phone}\nوسیله: {vehicle}\nشناسه تلگرام: {tg}",
        "admin.driver.approve_btn": "✅ تأیید",
        "admin.driver.reject_btn": "❌ رد",
        "admin.driver.approved_admin": "✅ راننده تأیید شد.",
    ...
    "ps": {
        ...
        "btn.saved_carts": "🛒 ساتل شوي ټوکرونه ({n})",
        "btn.restore_cart": "♻️ بیرته راوستل {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 ستاسو ساتل شوي ټوکرونه",
        "saved_carts.empty": "تاسو هیڅ ساتل شوی ټوکر نه لرئ.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} توکي — ฿{total}",
        "saved_carts.restored": "✅ {restored} توکي ستاسو ټوکر ته بیرته راوستل شول.",
        "saved_carts.restored_partial": "✅ {restored} توکي بیرته راوستل شول.\n⚠️ پرې ایښودل شوي (نشته):\n{skipped}",
        "saved_carts.discarded": "🗑 ساتل شوی ټوکر ړنګ شو.",
        "saved_carts.not_found": "دا ساتل شوی ټوکر نور شتون نلري.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ د تادیې پر مهال مبلغ په لاسي توګه دننه کړئ.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 د چلوونکي راجستر. د غوښتنې لپاره څو پوښتنو ته ځواب ورکړئ.",
        "driver.register.ask_name": "ستاسو بشپړ نوم څه دی؟",
        "driver.register.invalid_name": "مهرباني وکړئ سم نوم واستوئ (تر ۱۲۰ تورو پورې).",
        "driver.register.ask_phone": "ستاسو د تلیفون شمیره څه ده؟",
        "driver.register.invalid_phone": "مهرباني وکړئ سمه د تلیفون شمیره واستوئ.",
        "driver.register.ask_vehicle": "تاسو کوم وسیله کاروئ؟",
        "driver.register.invalid_vehicle": "مهرباني وکړئ له تڼیو څخه یوه وسیله وټاکئ.",
        "driver.register.submitted": "✅ غوښتنه واستول شوه! مدیر به یې ژر وڅیړي.",
        "driver.vehicle.motorbike": "🏍 موټرسایکل",
        "driver.vehicle.car": "🚗 موټر",
        "driver.vehicle.bicycle": "🚲 بایسکل",
        "driver.vehicle.foot": "🚶 پلی",
        "driver.approved": "🎉 تاسو د چلوونکي په توګه ومنل شوئ! آنلاین کیدو لپاره /driver واستوئ.",
        "driver.rejected": "ستاسو د چلوونکي غوښتنه ونه منل شوه.",
        "driver.not_approved": "ستاسو د چلوونکي حساب لاهم نه دی منل شوی.",
        "driver.status.pending": "⏳ ستاسو د چلوونکي غوښتنه د منلو په تمه ده.",
        "driver.status.rejected": "❌ ستاسو د چلوونکي غوښتنه رد شوه.",
        "driver.status.suspended": "🚫 ستاسو د چلوونکي حساب وځنډول شو.",
        "driver.status.online": "🟢 تاسو آنلاین یاست. فعال سفارشونه: {active}.",
        "driver.status.offline": "⚪ تاسو آفلاین یاست. فعال سفارشونه: {active}.",
        "driver.menu.go_online": "🟢 آنلاین کیدل",
        "driver.menu.go_offline": "⚪ آفلاین کیدل",
        "driver.online.prompt_location": "🟢 تاسو اوس آنلاین یاست! خپل ژوندی موقعیت شریک کړئ ترڅو نږدې سفارشونه درته وټاکو.",
        "driver.offline.done": "تاسو اوس آفلاین یاست.",
        "driver.location.received": "📍 موقعیت تازه شو.",
        "driver.offer.title": "🛎 د تحویلۍ نوې وړاندیز — سفارش {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ منل",
        "driver.offer.decline_btn": "❌ ردول",
        "driver.offer.accepted": "✅ سفارش {order_code} ستاسو شو!\n📍 {address}\nد اخیستلو او رسولو پر مهال لاندې تڼۍ کلیک کړئ.",
        "driver.offer.accept_ack": "✅ تاسو دا سفارش واخیست!",
        "driver.offer.taken": "بښنه غواړو، دا سفارش دمخه اخیستل شوی.",
        "driver.offer.declined": "تاسو دا وړاندیز رد کړ.",
        "driver.offer.expired": "د سفارش {order_code} وړاندیز پای ته ورسید.",
        "driver.customer.assigned": "🛵 ستاسو د سفارش #{order_code} لپاره چلوونکی پر لاره دی!",
        "driver.customer.eta": "🛵 ستاسو سفارش #{order_code} نږدې {minutes} دقیقې لرې دی.",
        "admin.driver.new_application": "🛵 د چلوونکي نوې غوښتنه\nنوم: {name}\nتلیفون: {phone}\nوسیله: {vehicle}\nد تلیګرام پیژند: {tg}",
        "admin.driver.approve_btn": "✅ منل",
        "admin.driver.reject_btn": "❌ ردول",
        "admin.driver.approved_admin": "✅ چلوونکی ومنل شو.",
    ...
    "fr": {
        ...
        "btn.saved_carts": "🛒 Paniers sauvegardés ({n})",
        "btn.restore_cart": "♻️ Restaurer {brand}",
        "btn.discard": "🗑",
        "saved_carts.title": "🛒 Vos paniers sauvegardés",
        "saved_carts.empty": "Vous n'avez aucun panier sauvegardé.",
        "saved_carts.entry": "🛒 {brand}{store} · {n} article(s) — ฿{total}",
        "saved_carts.restored": "✅ {restored} article(s) restauré(s) dans votre panier.",
        "saved_carts.restored_partial": "✅ {restored} article(s) restauré(s).\n⚠️ Ignorés (indisponibles) :\n{skipped}",
        "saved_carts.discarded": "🗑 Panier sauvegardé supprimé.",
        "saved_carts.not_found": "Ce panier sauvegardé n'est plus disponible.",
        ...
        "order.payment.promptpay.static_amount_note": "⚠️ Saisissez le montant manuellement lors du paiement.",
        ...
        # === Driver dispatch (Card 26) ===
        "driver.register.start": "🛵 Inscription livreur. Repondez a quelques questions pour postuler.",
        "driver.register.ask_name": "Quel est votre nom complet ?",
        "driver.register.invalid_name": "Veuillez envoyer un nom valide (jusqu'a 120 caracteres).",
        "driver.register.ask_phone": "Quel est votre numero de telephone ?",
        "driver.register.invalid_phone": "Veuillez envoyer un numero de telephone valide.",
        "driver.register.ask_vehicle": "Quel vehicule utilisez-vous ?",
        "driver.register.invalid_vehicle": "Veuillez choisir un vehicule parmi les boutons.",
        "driver.register.submitted": "✅ Candidature envoyee ! Un administrateur l'examinera bientot.",
        "driver.vehicle.motorbike": "🏍 Moto",
        "driver.vehicle.car": "🚗 Voiture",
        "driver.vehicle.bicycle": "🚲 Velo",
        "driver.vehicle.foot": "🚶 A pied",
        "driver.approved": "🎉 Vous etes approuve comme livreur ! Envoyez /driver pour vous mettre en ligne.",
        "driver.rejected": "Votre candidature de livreur n'a pas ete approuvee.",
        "driver.not_approved": "Votre compte livreur n'est pas encore approuve.",
        "driver.status.pending": "⏳ Votre candidature de livreur est en attente d'approbation.",
        "driver.status.rejected": "❌ Votre candidature de livreur a ete refusee.",
        "driver.status.suspended": "🚫 Votre compte livreur est suspendu.",
        "driver.status.online": "🟢 Vous etes EN LIGNE. Commandes actives : {active}.",
        "driver.status.offline": "⚪ Vous etes HORS LIGNE. Commandes actives : {active}.",
        "driver.menu.go_online": "🟢 Se mettre en ligne",
        "driver.menu.go_offline": "⚪ Se mettre hors ligne",
        "driver.online.prompt_location": "🟢 Vous etes en ligne ! Partagez votre position en direct pour qu'on vous attribue les commandes proches.",
        "driver.offline.done": "Vous etes maintenant hors ligne.",
        "driver.location.received": "📍 Position mise a jour.",
        "driver.offer.title": "🛎 Nouvelle offre de livraison — commande {order_code}\n📍 {address}\n💰 {total} ({payment})\n🚚 {type}",
        "driver.offer.accept_btn": "✅ Accepter",
        "driver.offer.decline_btn": "❌ Refuser",
        "driver.offer.accepted": "✅ La commande {order_code} est a vous !\n📍 {address}\nAppuyez ci-dessous lors du retrait et de la livraison.",
        "driver.offer.accept_ack": "✅ Vous avez pris cette commande !",
        "driver.offer.taken": "Desole, cette commande a deja ete prise.",
        "driver.offer.declined": "Vous avez refuse cette offre.",
        "driver.offer.expired": "L'offre pour la commande {order_code} a expire.",
        "driver.customer.assigned": "🛵 Un livreur est en route pour votre commande #{order_code} !",
        "driver.customer.eta": "🛵 Votre commande #{order_code} arrive dans environ {minutes} min.",
        "admin.driver.new_application": "🛵 Nouvelle candidature livreur\nNom : {name}\nTelephone : {phone}\nVehicule : {vehicle}\nID Telegram : {tg}",
        "admin.driver.approve_btn": "✅ Approuver",
        "admin.driver.reject_btn": "❌ Refuser",
        "admin.driver.approved_admin": "✅ Livreur approuve.",
